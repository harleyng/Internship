    ...
    >
      <form className={classes.modalContainer} onSubmit={handleModalSubmit}>
        <Paper className={classes.modalContent}>
          {action === "Delete" ? 
          <Typography className={classes.modalTitle} align='center' variant='h5'>Are your sure deleteing this period?</Typography>
          : (
            <>
          ...
          <Button type='submit' fullWidth>{action ==="Delete" ? 'Yes' : 'Submit'}</Button>
        </Paper>
      </form>
    </Modal>
  )
